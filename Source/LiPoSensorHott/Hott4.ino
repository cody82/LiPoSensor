...
void hottBuildEAM() {
  ...
  hottEAM.temp1 = 0;//(byte)Temperature + 20; // byte!! 46 = 25C, 20 = 0C
  
  hottEAM.altitude = 0;//500 + ((AbsoluteAltitude - GroundAltitude));
  
  hottEAM.climbrate1 = 0;//30000 + (Climbrate1*100);
  hottEAM.climbrate3 = 0;//120;
